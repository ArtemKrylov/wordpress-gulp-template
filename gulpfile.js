...
gulp.task("styles", function () {
  return (
    gulp
      .src("src/wp-content/themes/twentyseventeen/assets/sass/**/*.sass")
...
gulp.task("imgmin-theme", function () {
  return gulp
    .src("src/wp-content/themes/twentyseventeen/assets/images/**/*")
...
gulp.task("deploy-site", function () {
  ...
  return gulp.src(globs, { buffer: false }).pipe(conn.dest("/www/domain.com/")); // Путь до папки сайта на хостинге
});
...
if (gulpversion == 3) {
  gulp.task("watch", ["styles", "scripts", "browser-sync"], function () {
    gulp.watch(
      ["src/wp-content/themes/twentyseventeen/assets/sass/**/*.sass"],
      ["styles"]
    ); // Наблюдение за sass файлами в папке sass в теме
    gulp.watch(
      [
        "src/wp-content/themes/twentyseventeen/assets/libs/**/*.js",
        "src/wp-content/themes/twentyseventeen/assets/js/common.js",
      ],
      ["scripts"]
    ); // Наблюдение за JS файлами js в теме
    gulp.watch(
      "src/wp-content/themes/twentyseventeen/**/*.php",
      browsersync.reload
    ); // Наблюдение за sass файлами php в теме
  });
